...
const volumeHigh = document.querySelector("use[href='volume-hight']");
...
// roughly work out that what point in the video the user will skip to if
...
function updateFullscreenButton() {
	fullscreenButton.forEach((icon) => icon.classList.toggle("hidden"));
...
// if the video is paused, the controls should be shown
